...
define('DOMAIN_ID', "315804");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "62469c39ab7d6b932646ec9124803b240e7075019a20b1e708dbb1c7f30d89bf");
define('CREATED_TIMESTAMP', "1533893505");

/**
* The key to store the script in cache, or the name of the local cache file.
*/
define('CACHEKEY', 'prCachedPRIntegrationScriptFor315804');
/**
...
CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "hdwallpapers.faltupost.com",
));
